 ...
 * NOTE: key 31, 1, 0 are reserved.
 * key 0 is used as the default key. It gives read/write/execute permission.
 * key 31 could be reserved by the hypervisor.
 * key 1 is recommended to be not used.
 * PowerISA(3.0) page 1015, programming note.
 */
#ifdef CONFIG_PPC_4K_PAGES
/* On 4K PTE, we have bits to support only 8 keys; i.e keys 0 to 7. */
#define PKEY_INITIAL_ALLOCAION  0xc0ffffff
#else
